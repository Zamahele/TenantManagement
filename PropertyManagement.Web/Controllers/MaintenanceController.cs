...
public class MaintenanceController : BaseController
{
    ...
    // POST: /Maintenance/TenantCreate
    [HttpPost]
    [Authorize(Roles = "Tenant")]
    public async Task<IActionResult> TenantCreate(MaintenanceRequest model)
    {
        var userId = int.Parse(User.FindFirstValue(ClaimTypes.NameIdentifier));
        var tenant = await _context.Tenants.FirstOrDefaultAsync(t => t.UserId == userId);
        if (tenant == null)
        ...
        // Store reference number in TempData
